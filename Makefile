...
check-safety:
	...
	$(BANDIT_COMMAND_FLAG)poetry run bandit -ll -r scikit_obliquetree/
...
check-style:
	...
	$(MYPY_COMMAND_FLAG)poetry run mypy --config-file setup.cfg scikit_obliquetree tests/**/*.py
